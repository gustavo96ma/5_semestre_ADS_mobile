                        ...
                        children: [
                          TextFormField(
                            ...
                            validator: (valorEmail) {
                              ...
                              if (valorEmail.startsWith('prof_') &&
                                  valorEmail.endsWith('@unicv.edu.br')) {
                                  ...
                                  try {
                                    ...
                                    e senha: $_senhaInserida autenticado''');
                                      ...
                                      await _firebaseAuth.signInWithEmailAndPassword(
                                          email: _emailInserido, password: _senhaInserida);
                                    } else {
                                      print('''Usuário com email: $_emailInserido,
                                      ...
                                      FirebaseFirestore.instance.collection('usuarios').add({
                                        'usuario': _nomeUsuarioInserido,
                                        'isAdm': _isAdministrador,
